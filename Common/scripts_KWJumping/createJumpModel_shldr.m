function [model, trc, initPos] = createJumpModel_shldr(trc, attachMarkers, crop, S2sc, calibPose, EKFCodePath)
%Calculate link lengths for Healthy 2 STANDING data (LG EKF, CloudSLAM)
...
%     addpath(cd(cd('..')));
    ...
    model = rlCModel('JumpModel_shldr.xml');
