function [model, trc, initPos, modelLinks] = createJumpModel_v2(trc, attachMarkers, crop, S2sc, calibPose, EKFCodePath)
%Calculate link lengths for Jumping Data model.
% uses frames between crop(1) and crop(2) of steady standing data

%NOTE: this "v2" code makes offset of the thigh and shin links straight 
%downwards, rather than aligned with midpoint between knee and ankle
...
visu = 1; %for debugging/stepping through function
...
%     % take norm of above, offset ankle straight down, directly below knee
%     T(1:3,4) = [0,0,-norm(T(1:3,4))];
model.transforms(trNum).t = T;
model.forwardPosition;
