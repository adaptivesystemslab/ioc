function [J, A, x, b, J_cost_combined] = ioc_cost_func(z_init, lambda_use, J_cost_all, J_const_all, c_const, param)
% IOC cost function calc. combine the matrices generated by setup_ioc into
% the form that the pivot requires
[~, c_use] = vec2mat_multi(z_init, param.matVec_struct);
...
for ind_const = 1:length(J_const_all)
    ...
    x_const = [x_const; c_const_use*lambda_use(ind_const)];
end

A_baug = A_const*x_const;
b = b - A_baug;
