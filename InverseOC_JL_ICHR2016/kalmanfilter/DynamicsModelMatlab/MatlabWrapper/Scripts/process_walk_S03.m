...
time_stamp = '_2019_03_28_14_45_47';
...
ekf_lc.observation_noise = diag(repmat([0.01 0.01 0.01 0.1 0.1 0.1],1,5));
...
for i=100:size(mes,1)
    ...
    if((cur_active == 'l' && (mean(eSN_l(i:i)-eSN_r(i:i))) > 0 && norm(vel_r(i,:)) < 1  && cur_count > 10))
    ...
    elseif( (cur_active == 'r' && (mean(eSN_r(i:i)-eSN_l(i:i))) > 0 && norm(vel_l(i,:)) < 1 && cur_count > 10))
        cur_active = 'l';
        cur_count = 0;
    end
