...
methods
    ...
    function h = plot(obj,varargin)
        ...
        elseif ~isempty(obj.gyroscopeUncalibrated)
            ...
            ylabel('Angular velocity ADC Values');
        end
        xlabel('Time [s]');
     ...
     function h = plotUncalibrated(obj,varargin)
        h = figure;
        ...
        h1 = subplot(2, 1, 1);
        if ~isempty(obj.accelerometerUncalibrated)
            plot(time, obj.accelerometerUncalibrated);
            ylabel('Linear acceleration ADC Values');
        end

        h2 = subplot(2, 1, 2);
        if ~isempty(obj.gyroscopeUncalibrated)
            plot(time, obj.gyroscopeUncalibrated);
            ylabel('Linear gyroscope ADC Values');
        end
        xlabel('Time [s]');
