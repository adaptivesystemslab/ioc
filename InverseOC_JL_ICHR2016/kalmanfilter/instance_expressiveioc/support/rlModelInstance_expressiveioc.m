classdef rlModelInstance_expressiveioc < rlModelInstance % < rlModel
    properties
%         jointCentreArray = { ...
%             {'SHOULDER_R_JC',		'RCAJ',}; ...
...
%             };
        ...
        jointCentreArray = { ...         
            {'HIP_BASE_JC',			'LIAS', 'RIAS', 'RIPS', 'LIPS'}; ...
            {'L5_JC',				'SCR'}; ...
            {'T10_JC',              'TV10', 'SXS'}; ...
            {'C7_JC',				'CV7', 'SJN'}; ...
            {'C1HEAD_JC',			'LAH', 'LPH', 'RPH', 'RAH'}; ...
            %
            {'SHOULDER_R_JC',		'RCAJ',}; ...
            {'ELBOW_R_JC',			'RHLE', 'RHME',}; ...
            {'WRIST_R_JC',			'RUSP', 'RRSP'}; ...
            ...
            %
            {'SHOULDER_L_JC',		'LCAJ'}; ...
            {'ELBOW_L_JC',			'LHLE', 'LHME'}; ...
            {'WRIST_L_JC',			'LUSP', 'LRSP'}; ...
            {'HAND_L_JC',			'LHA1',  'LHA2', 'LHA3', 'LHA4'}; ...
            };
        ...
        linkLengthArray = ...
            {...
            {'length_base_l5',                  'body_base',                    'HIP_BASE_JC',      'L5_JC'}; ...     % link offsets for torso
            {'length_l5_t10',                   'body_l5_t10',                  'L5_JC',            'T10_JC'}; ...
            {'length_t10_c7',                   'body_t10_c7',                  'T10_JC',           'C7_JC'}; ...
            {'length_c7_c1head',                'body_c7_c1head',               'C7_JC',            'C1HEAD_JC'}; ...
            {'length_c7rshoulder_rshoulder',	'body_c7rshoulder_rshoulder',   'C7_JC',            'SHOULDER_R_JC'}; ...
            ...
            {'length_c7lshoulder_lshoulder',    'body_c7lshoulder_lshoulder',   'C7_JC',            'SHOULDER_L_JC'}; ...
        ...
        sensorAttachmentArray = ...
            {...
            {'frame_l5_0',          'L5_JC',            'SCR'}; ...
            {'frame_t10_0',         'T10_JC',           'SJN', 'SXS'}; ...
            {'frame_c7_0',          'C7_JC',            'CV7', 'TV10'}; ...
            ...
            {'frame_lshoulder_0',   'SHOULDER_L_JC',    'LCAJ'}; ...                              % sensor placements for left upper body
            {'frame_lelbow_0',      'ELBOW_L_JC',       'LHLE', 'LHME'}; ...
            {'frame_lwrist_0',      'WRIST_L_JC',       'LUSP', 'LRSP'}; ...
            };
...
%             };       
        ...
        sensorSecondaryAttachmentArray = ...
            {...
            {'body_base',           'HIP_BASE_JC',  'LIAS', 'RIAS', 'RIPS', 'LIPS'}
            {'frame_t10_0',         'T10_JC',       'LUS1', 'LUS2', 'LUS3', 'LUS4'}; ...
            {'frame_c7_0',          'C7_JC',        'THS1', 'THS2', 'THS3', 'THS4'}; ...  
            {'frame_c1head_end',	'C1HEAD_JC',    'LAH', 'LPH', 'RPH', 'RAH'}; ...
            ...
            {'frame_lelbow_0',      'ELBOW_L_JC',   'LUPA4', 'LUPA3', 'LUPA2', 'LUPA1'};...
            {'frame_lwrist_0',      'WRIST_L_JC',   'LFA4', 'LFA3', 'LFA2', 'LFA1'}; ...
            {'frame_lhand_end', 	'HAND_L_JC',    'LHA4', 'LHA3', 'LHA2', 'LHA1'}; ...
            };  
    ...
    methods
        function obj = rlModelInstance_expressiveioc(subjectId)
            obj.datasetName = 'IOC';
