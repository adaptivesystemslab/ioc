function h14 = plot_cost_fct(feature_full, segmentInfo, ...
    t_obs, t_doc, q_obs, q_doc, avgWeightArray_belowThres, resnromAll_lsqlin_const_minRMSE_array_belowThres, ...
...
barObj = bar(t_obs, avgWeightArray_belowThres(:, cost_function_names_sorted_ind), 'stacked');
shading flat
