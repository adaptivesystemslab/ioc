function [specStruct, variableFactors] = script4_pr2
% set up base settings
setting_costfunction = '7';
setting_dataset = 'pr2';
setting_iocvalidation = 'resnorm';
setting_outputstring = 'test';
setting_normalization = 'none'; % rang rset none

% sourceDataMatFolder = 'C:/Users/Maram/OneDrive - sfu.ca/CARIS/Papers/ICRA2021/Quantifying demonstration qulaity/Data/OMPL_data/Joint';
sourceDataMatFolder = 'C:/Users/Maram/OneDrive - sfu.ca/CARIS/Papers/ICRA2021/Quantifying demonstration qulaity/Data/Lab_data_05102020/Session 2/Chinmay_trial1_face2_close';
resultsDataFolder = 'C:/Users/Maram/OneDrive - sfu.ca/CARIS/Papers/ICRA2021/Quantifying demonstration qulaity/Scripts/ioc-pr2/Results';
...
switch setting_costfunction
    case '7'
        cost_function_names{1} = 'task_length';
        cost_function_names{2} = 'joint_length';
        cost_function_names{3} = 'orientation_length';
        cost_function_names{4} = 'task_jerk';
        cost_function_names{5} = 'joint_jerk'; %'';
        cost_function_names{6} = 'manipulability'; %
        cost_function_names{7} = 'joint_limit'; %
