function [J, A, x, b, J_cost_combined] = regressorMatrixCondition(z_init, J_cost_all, J_const_all, c_const, param)
% IOC cost function calc. combine the matrices generated by setup_ioc into
% the form that the pivot requires
[lambda_use_cell, c_use] = vec2mat_multi(z_init, param.matVec_struct);
