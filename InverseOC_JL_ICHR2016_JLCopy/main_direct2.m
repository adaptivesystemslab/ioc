function [feature_use, J_array, J_contrib, output_direct] = main_direct2(c_cost, c_const, feature_win, param, param_opt)
    ...
    y = feature_win.q(param.intermed_ind);
    dy = feature_win.dq(param.intermed_ind);
    ddy = feature_win.ddq(param.intermed_ind);
    [y_init, dy_init, ddy_init] = generateTrajectory(y, param.intermed_ind, param.t_spline, dy, ddy, param);
