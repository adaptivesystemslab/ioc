...
setting_pathToOutput = '../results/ioc';
...
variableFactors.batchWindowBreakdownFactor = 50000; % (3000) break down the batch runs to increments of this factor, \pm 2 seconds on both sides
