...
#SBATCH --time=4-00:00:00      # adjust this to match the walltime of your job
#SBATCH --nodes=1      
#SBATCH --ntasks=1
...
srun matlab -nodisplay -nojvm -singleCompThread -r "configFilePath = '../Data/json_IOC_IIT/IOC_IITFatigue_Sharcnet_subj09_7DOF_4CF.json'; IOCMain;" -sd "/project/6001934/jf2lin/gitlab/expressive-ioc/InverseOC"